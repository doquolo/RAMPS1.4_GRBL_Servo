...
#define HOMING_CYCLE_0 (1 << X_AXIS)  // REQUIRED: move X,Y at the same time.
...
#define SPINDLE_MAX_RPM 180.0 // Max spindle RPM. This value is equal to 100% duty cycle on the PWM.
