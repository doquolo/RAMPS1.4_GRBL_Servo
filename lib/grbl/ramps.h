...
#define CHECK(var,pos) ((var) & (1<<(pos)))
	...
	* @param value
	*/
	static void rampsWriteDisable(uint8_t value) {
	...
	* @param value
	*/
	static void rampsWriteSteps(uint8_t value) {
  ...
  * Write stepper direction (Direction Pins)
	* @param value
	*/
	static void rampsWriteDirections(uint8_t value) {
  ...
  */ 
  static void rampsLimitsEnableInterrups() {
  ...
  */ 
  static void rampsLimitsDisableInterrups() {
  ...
  */ 
  static void rampsInitLimits(bool hardLimitEnable) {
  ...
  */ 
  static uint8_t rampsCheckLimits() {
  ...
  */ 
  static void rampsPrintLimitStatus(const char *s, uint8_t limit_state) {
      printString(s);
